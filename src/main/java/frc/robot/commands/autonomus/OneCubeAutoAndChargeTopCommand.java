...
public class OneCubeAutoAndChargeTopCommand extends SequentialCommandGroup {
    public OneCubeAutoAndChargeTopCommand() {
        addCommands(
                ...
                new ParallelDeadlineGroup(
                        new SwerveDrivePathCommand("One_Cube_Charge_Top", new PathConstraints(2, 1.5),
                                false),
